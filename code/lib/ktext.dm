...
kText
	...
	proc
		/**
		 * Returns a strings character length excluding spaces.
		 * @param string>> The string to be queried.
		 */
		len(string)
			var/count = 0, start=1, end=length(string)
		 ...
		 * @param string	The string to be queried.
		 * @param pos		Where to start searcing for whitespace.
		 ...
		 * @param string	The string to be queried.
		 * @param sub		The string to searc for.
		 ...
		 * @param string	The string to be queried.
		 * @param sub		The string to be searced for.
		 ...
		 * @param	needle		The set of words to be searced for.
