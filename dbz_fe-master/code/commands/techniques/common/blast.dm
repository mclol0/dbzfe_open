Command/Technique
	blast
		...
		helpDescription = "Basic energy attack. Focus your ki into your hand and then launch it towards your enemy."
		skillDatum = /fEAttk/blast
		...
		command(mob/user, mob/target=user:fCombat._getLastTarget()) {
			...
			user.kiAttk = new /fEAttk/blast(user,target,src)
		}